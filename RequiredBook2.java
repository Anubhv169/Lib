...
public class RequiredBook2 extends JFrame {
	...
	public RequiredBook2(String str) {
		super(str);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String name = RequiredBook2.this.textField.getText();
		        String bname = RequiredBook2.this.textField_4.getText();
		        String bauthor = RequiredBook2.this.textField_5.getText();
		        String contact = RequiredBook2.this.textField_2.getText();
		        String email = RequiredBook2.this.textField_3.getText();
		        ...
		        {
		          JOptionPane.showMessageDialog(RequiredBook2.this.getParent(), "pls fill all the entries", "error", 0);
		        ...
		        else
		        {
      	         ...
      	         ps1.setString(6,bauthor);
      	          ...
      	          if(flag1 ==1)
      	          {
      	        	JOptionPane.showMessageDialog(RequiredBook2.this.getParent(), "Book Saved");
      	        	textField.setText(null);
		    		 textField_4.setText(null);
		    		 textField_2.setText(null);
		    		 textField_3.setText(null);
      	          ...
      	          {
      	        	JOptionPane.showMessageDialog(RequiredBook2.this.getParent(), "Book not Saved Check the details again", "error", 0);
      	        	textField.setText(null);
		    		textField_4.setText(null);
		    		textField_2.setText(null);
		    		textField_3.setText(null);
