...
public class ChangeSelfPass3 extends JFrame {
	private JTextField textField;
	private JTextField textField_1;
	private JPasswordField passwordField;
	private JPasswordField passwordField_1;
	private JPasswordField passwordField_2;
	public ChangeSelfPass3(String str) {
		super(str);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String name = ChangeSelfPass3.this.textField.getText();
		        String contact = ChangeSelfPass3.this.textField_1.getText();
		        String pass = String.copyValueOf(ChangeSelfPass3.this.passwordField.getPassword());
		        String newpass = String.copyValueOf(ChangeSelfPass3.this.passwordField_1.getPassword());
		        String newrepass = String.copyValueOf(ChangeSelfPass3.this.passwordField_2.getPassword());
		        if ((name.length() == 0) || (contact.length() == 0) || (contact.length() == 0) || (pass.length() == 0) || (newpass.length() == 0) || (newrepass.length() == 0))
		        {
		          JOptionPane.showMessageDialog(ChangeSelfPass3.this.getParent(), "pls fill all the entries", "error", 0);
		        }
		        else if (!newpass.equals(newrepass))
		        {
		          JOptionPane.showMessageDialog(ChangeSelfPass3.this.getParent(), "new password and Confirm password should be same");
		          ChangeSelfPass3.this.textField.setText(null);
		          ChangeSelfPass3.this.textField_1.setText(null);
		          ChangeSelfPass3.this.passwordField.setText(null);
		          ChangeSelfPass3.this.passwordField_1.setText(null);
		          ChangeSelfPass3.this.passwordField_2.setText(null);
		        }
		        else
		        {
		            ...
		            if ((flag != 0) && (flag1 != 0))
		            {
		              JOptionPane.showMessageDialog(ChangeSelfPass3.this.getParent(), "Password Changed");
		              ChangeSelfPass3.this.textField.setText(null);
			          ChangeSelfPass3.this.textField_1.setText(null);
			          ChangeSelfPass3.this.passwordField.setText(null);
			          ChangeSelfPass3.this.passwordField_1.setText(null);
		            ...
		            {
		              JOptionPane.showMessageDialog(ChangeSelfPass3.this.getParent(), "There are some error");
		              ChangeSelfPass3.this.textField.setText(null);
			          ChangeSelfPass3.this.textField_1.setText(null);
			          ChangeSelfPass3.this.passwordField.setText(null);
			          ChangeSelfPass3.this.passwordField_1.setText(null);
