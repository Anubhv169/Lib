...
protected Object comboBox;
  ...
  public Registration(String str)
  {
    ...
    btnNewButton.addActionListener(new ActionListener()
    {
      ...
      {
        String name = Registration.this.textField.getText();
        String contact = Registration.this.textField_1.getText();
        String email = Registration.this.textField_2.getText();
        String uname = (String)comboBox.getSelectedItem();
        String pass = String.copyValueOf(Registration.this.passwordField.getPassword());
        String repass = String.copyValueOf(Registration.this.passwordField_1.getPassword());
        if ((name.length() == 0) || (contact.length() == 0) || (email.length() == 0) || (uname.length() == 0) || (pass.length() == 0) || (repass.length() == 0))
        {
          JOptionPane.showMessageDialog(Registration.this.getParent(), "pls fill all the entries", "error", 0);
          Registration.this.textField.setText(null);
          Registration.this.textField_1.setText(null);
          Registration.this.textField_2.setText(null);
          Registration.this.passwordField.setText(null);
          Registration.this.passwordField_1.setText(null);
          comboBox.setSelectedIndex(0);
        }
        else if (!pass.equals(repass))
        {
          JOptionPane.showMessageDialog(Registration.this.getParent(), "password and repassword are same");
          Registration.this.textField.setText(null);
          Registration.this.textField_1.setText(null);
          Registration.this.textField_2.setText(null);
          Registration.this.passwordField.setText(null);
        ...
        else
        {
          ...
          if ((flag != 0) && (flag1 != 0))
          {
            JOptionPane.showMessageDialog(Registration.this.getParent(), "Record inserted");
            Registration.this.textField.setText(null);
            Registration.this.textField_1.setText(null);
            Registration.this.textField_2.setText(null);
            Registration.this.passwordField.setText(null);
          ...
          {
            JOptionPane.showMessageDialog(Registration.this.getParent(), "registration failed");
            Registration.this.textField.setText(null);
            Registration.this.textField_1.setText(null);
            Registration.this.textField_2.setText(null);
            Registration.this.passwordField.setText(null);
